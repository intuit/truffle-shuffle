...
4.  2 फाइलों के साथ एक फोल्डर कार्डगैलरी बनाएं:
    ...
    -   ऐप/src/main/kotlin/com/intuit/truffle/shuffle/cardGallery/CustomizeAdapter.kt के समान CustomizeAdapter
        ...
        -   अपने card_layout.xml में विचारों के लिए कार्ड सामग्री में डेटा सामग्री सेट करने के लिए getViewContent () फ़ंक्शन को ओवरराइड करें, अर्थात। टेक्स्ट को टेक्स्ट व्यू में सेट करना
