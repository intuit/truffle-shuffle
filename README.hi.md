...
उदाहरण परियोजना को चलाने के लिए, रेपो को क्लोन करें और इसके माध्यम से Android एप्लिकेशन चलाएं[एंड्रॉइड स्टूडियो](https://developer.android.com/studio/) on an Emulator.
